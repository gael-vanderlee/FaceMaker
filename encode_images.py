...
def main():
    ...
    parser.add_argument('--src_dir', default=config.aligned_dir, help='Directory with images for encoding')
    parser.add_argument('--generated_images_dir', default=config.gen_images_dir, help='Directory for storing generated images')
    parser.add_argument('--dlatent_dir', default=config.latents_dir, help='Directory for storing dlatent representations')
    parser.add_argument('--data_dir', default='data', help='Directory for storing optional models')
    parser.add_argument('--mask_dir', default='outputs/masks', help='Directory for storing optional masks')
    ...
    parser.add_argument('--early_stopping_threshold', default=0.05, help='Stop after this threshold has been reached', type=float)
    ...
    parser.add_argument('--use_l1_penalty', default=0.3, help='Use L1 penalty on latents; 0 to disable, > 0 to scale.', type=float)
    ...
    # Video params
    parser.add_argument('--video_dir', default='outputs/videos', help='Directory for storing training videos')

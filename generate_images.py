...
if __name__ == "__main__":
    ...
    parser.add_argument('--raw_dir', default=config.raw_dir, help='Directory with raw images for face alignment')
    parser.add_argument('--aligned_dir', default=config.aligned_dir, help='Directory for storing aligned images')

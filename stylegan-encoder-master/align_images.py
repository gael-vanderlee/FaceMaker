...
if __name__ == "__main__":
    ...
    parser.add_argument('--raw_dir', default=Path(__file__).resolve().parent / "raw_images/",
                        help='Directory with raw images for face alignment')
    parser.add_argument('--aligned_dir', default=Path(__file__).resolve().parent / "aligned_images/",
